...
<body>
    ...
    <div>
        ...
        <p>
            <asp:Button ID="btnGetCitiesForZip" runat="server" Text="Get Cities For Zip Code" OnClick="btnGetCitiesForZip_Click" />
&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnGetCitiesNearbyZip" runat="server" Text="Get Cities Nearby Zip" OnClick="btnGetCitiesNearbyZip_Click" />
        </p>
        <p>
            <asp:TextBox ID="txtCityResults" runat="server" Height="262px" TextMode="MultiLine" Width="752px"></asp:TextBox>
        </p>
    </form>
</body>
</html>
